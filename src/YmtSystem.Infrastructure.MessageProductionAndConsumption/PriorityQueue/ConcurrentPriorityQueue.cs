...
{ 
   ...
   /// <summary>Provides a thread-safe priority queue data structure.</summary> 
        ...
        where TKey : IComparable<TKey>
    {
        ...
        public KeyValuePair<TKey, TValue> TryDequeue()
        {
            var o = default(KeyValuePair<TKey, TValue>);           
            TryDequeue( out o);
            return o;
        }

        public KeyValuePair<TKey, TValue> TryDequeue(KeyValuePair<TKey, TValue> defaultV)
        {
            //var o = default(KeyValuePair<TKey, TValue>);
            TryDequeue(out defaultV);
            return defaultV;
        }
        ...
        public KeyValuePair<TKey, TValue> TryPeek()
        {
           var result = default(KeyValuePair<TKey, TValue>);
           TryPeek(out result);
           return result;
        }
