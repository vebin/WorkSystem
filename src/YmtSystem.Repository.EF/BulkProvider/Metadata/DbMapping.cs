...
namespace YmtSystem.Repository.EF.BulkProvider.Metadata
{
    internal class DbMapping
    {
        ...
        private void MapColumn(string identity, TableMapping tableMapping, EdmProperty property)
        {
            ...
            {
                Console.WriteLine("{0},{1},{2}", identity, columnName, ex.ToString());
            }
        }
