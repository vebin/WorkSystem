...
namespace YmtSystem.Domain.Shard.NMoneys.Serialization
{
	/// <summary>
	/// Provides JavaScript Object Notation (JSON) format conversions for <see cref="CurrencyIsoCode"/>.
	/// </summary>
	public class CurrencyCodeConverter : JavaScriptConverter
	{
		...
		/// </summary>
		/// <remarks>Only <see cref="CurrencyIsoCode"/> instances can be handled.</remarks>
		/// <returns>
