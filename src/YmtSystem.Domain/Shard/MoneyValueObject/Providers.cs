...
using YmtSystem.Domain.Shard.NMoneys.Support.Ext;
...
namespace YmtSystem.Domain.Shard.NMoneys
{
    ...
    {
        private static readonly string _resourceName = "YmtSystem.Domain.Shard.MoneyValueObject.Currencies.xml";//typeof(Currency).Namespace + "." + "Currencies.xml";
