namespace YmtSystem.Domain.Specifications
{
    ...
    public class OrSpecification<T> : CompositeSpecification<T>
    {
        ...
        {
            //var body = Expression.OrElse(Left.SatisfiedBy().Body, Right.SatisfiedBy().Body);
            //return Expression.Lambda<Func<T, bool>>(body, Left.SatisfiedBy().Parameters);
            return Left.SatisfiedBy().Or(Right.SatisfiedBy());
        }
        #endregion
    }
}
