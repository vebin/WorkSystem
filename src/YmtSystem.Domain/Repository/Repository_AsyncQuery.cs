namespace YmtSystem.Domain.Repository
{
    ...
    public abstract partial class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public abstract Task<TEntity> AsyncFindOne(TimeSpan timeOut, params object[] key);      
        /// <summary>
        ...
        public abstract Task<IEnumerable<TEntity>> AsyncFindAll<TSortKey>(Expression<Func<TEntity, TSortKey>> sortPredicate, SortOrder sortOrder);
    }
}
