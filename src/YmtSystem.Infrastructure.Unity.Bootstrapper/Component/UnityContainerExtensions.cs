namespace YmtSystem.Infrastructure.Container.Unity.Bootstrapper
{
    ...
    public static class UnityContainerExtensions
    {
        ...
        [DebuggerStepThrough]
        public static IUnityContainer RegisterTypeAsSingleton(this IUnityContainer instance, Type fromType, Type toType, params InjectionMember[] members)
        {
            lock (instance)
                return instance.RegisterType(fromType, toType, new ContainerControlledLifetimeManager(), members);
        }
        [DebuggerStepThrough]
