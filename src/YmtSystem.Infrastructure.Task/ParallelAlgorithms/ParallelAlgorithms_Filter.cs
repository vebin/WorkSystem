...
namespace System.Threading.Algorithms
{
    public static partial class ParallelAlgorithms
    {
        ...
        /// modify 2013.7.15 lg
        public static IList<T> Filter<T>(this IList<T> input, Func<T, Boolean> predicate)
        {
        ...
        /// <returns>A new list containing all those elements from the input that passed the filter.</returns>
        ///  modify 2013.7.15 lg
        public static IList<T> Filter<T>( this IList<T> input, ParallelOptions parallelOptions, Func<T, Boolean> predicate)
        {
