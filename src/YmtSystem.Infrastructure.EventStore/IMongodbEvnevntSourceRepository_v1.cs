...
{
    public interface IMongodbEvnevntSourceRepository<TEntity>
        where TEntity :class       
    {
        #region [ 不指定数据库，表 ]
        ...
        void Remove(string name, BsonValue value);
        ...
        #region [基于Query 查询]
        TEntity FindOne(IMongoQuery query);
        ...
        void AsyncAdd(TEntity entity, string dbName, string collectionName); 
        #endregion
        #region [ 指定数据库，表 ]
